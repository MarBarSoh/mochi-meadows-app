...
const ACTIVITY_DATA: Record<string, any> = {
  ...
  time: {
    ...
    color: colors.blue,
    tag: 'PHOTO HUNT',
    tagline: 'Match archival photos to real Jalan Besar spots — unlock a Jalan Besar Voucher',
    ...
    reward: 'Kapitan Cap + Jalan Besar Voucher',
    rewardEmoji: '🎟️',
    ...
    tips: [
      '🎟️ Complete any 3 landmarks to unlock a Jalan Besar Voucher',
